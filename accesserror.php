...
<head>
    ...
    <meta name="keywords" content="<?php echo $json_seo_by_id_result->data[0]->keywords; ?>"/>
    ...
    <title>网站名称已替换VPN--未授权 | 更快速的VPN, 更稳定的ShadowSocks</title>
            ...
            <div class="row my-pic-row">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 item">
                <div class="conversation thumbnail" >
                  ...
                  <div class="order-line">你没有访问当前页面的权限</div>
                  <div class="order-line"><a href="index.php" class="btn btn-success">返回首页</a></div>
                  <div class="clear"></div>
                </div>
              </div>
